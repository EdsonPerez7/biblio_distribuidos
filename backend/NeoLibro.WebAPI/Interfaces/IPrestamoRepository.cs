...
namespace NeoLibroAPI.Interfaces
{
    ...
    /// Define el contrato para las operaciones de acceso a datos de préstamos
    /// </summary>
    public interface IPrestamoRepository
    {
        ...
        /// <summary>
        /// Verifica si un ejemplar tiene préstamos activos
        /// </summary>
        /// <param name="ejemplarId">ID del ejemplar</param>
        /// <returns>True si tiene préstamos activos, False si no</returns>
        bool TienePrestamosActivos(int ejemplarId);
